...
handler = logging.handlers.WatchedFileHandler(
    os.environ.get("LOGFILE", "../logs/food_MT_LewisandClarkHelena.log"))
...
if __name__ == '__main__':
	...
	donekeys=r.keys('canMT_LewisandClarkHelena_*')
	...
	for line in f:
		...
		keyname=('canMT, LewisandClarkHelena,%s')%(bizid)
		...
		if data != None:
			...
			for row in recordrow:
				...
				inspectdata["InspScore"]=cell[3].text
			...
			if inspections != {}:
				...
				r.set('canMT_LewisandClarkHelena_'+bizid, pickle.dumps(inspections[inspectid])) 
			#~ time.sleep(2)
		else:
