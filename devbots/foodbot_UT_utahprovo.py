...
handler = logging.handlers.WatchedFileHandler(
    os.environ.get("LOGFILE", "../logs/food_UT_Provo.log"))
...
if __name__ == '__main__':
	...
	donekeys=r.keys('canUT_utahprovo_*')
	...
	for line in f:
		...
		if data != None:
			...
			if inspections != {}:
				...
				r.set('canUT_Provo_'+bizid, pickle.dumps(inspections[inspectid])) 
			#~ time.sleep(2)
		else:
