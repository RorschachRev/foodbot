...
handler = logging.handlers.WatchedFileHandler(
    os.environ.get("LOGFILE", "../logs/food_UT_CacheNorthLogan.log"))
...
if __name__ == '__main__':
	...
	donekeys=r.keys('canUT_CacheNorthLogan_*')
	...
	for line in f:
		...
		keyname=('UT_CacheNorthLogan_%s')%(bizid)
		...
		if data != None:
			...
			if inspections != {}:
				...
				r.set('canUT_CacheNorthLogan_'+bizid, pickle.dumps(inspections[inspectid])) 
			#~ time.sleep(2)
		else:
