...
handler = logging.handlers.WatchedFileHandler(
    os.environ.get("LOGFILE", "../logs/food_MO_ClayLiberty.log"))
...
if __name__ == '__main__':
	...
	donekeys=r.keys('canMO_ClayLiberty_*')
	...
	for line in f:
		...
		keyname=('canMO_ClayLiberty_%s')%(bizid)
		...
		if data != None:
			...
			if inspections != {}:
				...
				r.set('canMO_ClayLiberty_'+bizid, pickle.dumps(inspections[inspectid])) 
			#~ time.sleep(2)
		else:
